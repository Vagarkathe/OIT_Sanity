...
public class ListSubDomainsSimple {
	...
	public void endpoints_of_list_subdomains_simple_api_are_sent_to_server() {
		RestAssured.baseURI= baseUrl+ "/v2/catalog/";
		RestAssured.basePath="{environment}/subdomains/simples";
	...
	@Then("Fetch the response and validate the code as {int}")
	public void fetch_the_response_and_validate_the_code_as(Integer int1) {
