...
public class GetLog {
	...
	@Given("Get Log {int} API valid endpoints are sent to server")
	public void get_log_api_valid_endpoints_are_sent_to_server(Integer int1) {
		RestAssured.baseURI= baseUrl+ "/v2/interfacecontract/";
		RestAssured.basePath="{environment}/getLogDeploy";
	...
	@Then("Validate the response of Log API contains {int}")
	public void validate_the_response_of_log_api_contains(Integer int1) {
