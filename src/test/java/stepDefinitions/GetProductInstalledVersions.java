...
public class GetProductInstalledVersions {
	...
	@Given("Get Product Installed Versions {int} API valid endpoints are sent to server")
	public void get_product_installed_versions_api_valid_endpoints_are_sent_to_server(Integer int1) {
		RestAssured.baseURI= baseUrl+ "/v2/interfacecontract/";
		RestAssured.basePath="{environment}/product/installed/versions";
	...
	@Then("Validate {int} as the status code and Fetch the response of Product Installed Versions API")
	public void validate_as_the_status_code_and_fetch_the_response_of_product_installed_versions_api(Integer int1) {
