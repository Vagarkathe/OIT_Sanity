...
public class ListDatasets {
	...
	public void hit_the_list_datasets_api_with_its_details() {
		RestAssured.baseURI= baseUrl+ "/v2/catalog/";
		RestAssured.basePath="{environment}/filter/dataset";
	...
	@Then("Fetch the response and validate {int} as the response code")
	public void fetch_the_response_and_validate_as_the_response_code(Integer int1) {
