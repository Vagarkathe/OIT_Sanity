...
public class ListDatasourcesWithOrangeCartographie {
	...
	public void endpoints_of_list_datasources_with_orange_cartographie_api_are_sent_to_server() {
		RestAssured.baseURI= baseUrl+ "/v2/catalog/";
		RestAssured.basePath="{environment}/datasources/cartographies";
	...
	@Then("Get the response and check the code as {int}")
	public void get_the_response_and_check_the_code_as(Integer int1) {
