...
public class ExportSampleAPI {
	...
	public void export_sample_catelog_endpoint() {
		RestAssured.baseURI= baseUrl+ "/v2/catalog/";
		RestAssured.basePath="{environment}/datasource/{datasource}/dataset/{dataset}/datalayer/{datalayer}/samples/export";
		request_spec = given().baseUri(RestAssured.baseURI)
				.pathParam("environment", "INT")
				.pathParam("datasource", "GOLD")
				.pathParam("dataset", "EQ_NOTE")
	...
	public void send_the_api_to_server_and_check_the_response_contains_status_as_ok() {
