...
public class ListContactsByDatasource {
	...
	public void endpoints_of_list_contacts_by_datasource_api_are_sent_to_server() {
		RestAssured.baseURI= baseUrl+ "/v2/catalog/";
		RestAssured.basePath="{environment}/datasource/{datasource}/contacts?limit=28722700&offset=28722700";
	...
	@Then("Check the response code {int} OK")
	public void check_the_response_code_ok(Integer int1) {
