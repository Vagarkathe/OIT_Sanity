...
public class InterfaceContractUploadContractMultipleJSONAPI {
	...
	public void interfacecontract_upload_the_multiple_json() {
		RestAssured.baseURI= baseUrl+ "/v2/interfacecontract/";
		RestAssured.basePath="{environment}/upload/jsonMultiple";
	...
	public void multiple_josn_version_should_be_update() {
