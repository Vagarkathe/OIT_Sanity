...
public class GetAllDataSetVersion {
	...
	@Given("Get All Data Set Version {int} API valid endpoints sent to server")
	public void get_all_data_set_version_api_valid_endpoints_sent_to_server(Integer int1) {
		RestAssured.baseURI= baseUrl+ "/v2/interfacecontract/";
		RestAssured.basePath="{environment}/datasource/{id}/versions";
	...
	@Then("Check the response of All Data Set Version API code as {int} and fetch the response")
	public void check_the_response_of_all_data_set_version_api_code_as_and_fetch_the_response(Integer int1) {
