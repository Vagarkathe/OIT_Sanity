...
public class GetDatasetReferanceAPI {
...
//	File SaveParameterjson = new File("src/test/resources/Payloads/SaveParameter.json");
	...
	public void send_the_get_dataset_referance_api_to_server() {
		RestAssured.baseURI= baseUrl+ "/v2/catalog/";
		RestAssured.basePath="{environment}/datasource/{datasource}/references";
	...
	@Then("Validate status code as {int} OK and check the response")
	public void validate_status_code_as_ok_and_check_the_response(Integer int1) {
