...
public class ListDatasetReferenceAPI {
	...
	public void valid_endpoints_of_list_dataset_reference_api_are_sent_to_server() {
		RestAssured.baseURI= baseUrl+ "/v2/catalog/";
		RestAssured.basePath="{environment}/datasource/{datasource}/dataset/{dataset}/references";
	...
	@Then("Response contains {int} OK")
	public void response_contains_ok(Integer int1) {
