...
public class InterfaceContractUploadContractByXLSAPI {
	...
	public void interfacecontract_upload_the_xls() {
		RestAssured.baseURI= baseUrl+ "/v2/interfacecontract/";
		RestAssured.basePath="{environment}/upload/xls";
	...
	public void version_should_be_update() {
		response = request_spec
				...
				.multiPart("file", new File("src/test/resources/Payloads/EDH-InterfaceContract-V16.0-DSIEP-29B(Dinamo)-v0.4.xlsm"))
