...
public class SaveContactAPI {
	
	RequestSpecification request_spec;
	Response response;
	
	String baseUrl = "https://portal-int-edh.bigdata.intraorange/api";
	File Savecontactjson = new File("src/test/resources/Payloads/saveContact.json");
...
Scenario scn;
	...
	public void hit_the_save_contact_api_with_its_details() {
		RestAssured.baseURI= baseUrl+ "/v2/catalog/";
		RestAssured.basePath="{environment}/datasource/{datasource}/contact";
	...
	@Then("Fetch the response and validate {int} OK as the response code")
	public void fetch_the_response_and_validate_ok_as_the_response_code(Integer int1) {
