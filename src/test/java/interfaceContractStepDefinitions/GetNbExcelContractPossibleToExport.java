...
public class GetNbExcelContractPossibleToExport {
	...
	@Given("Get Nb Excel Contract Possible To Export {int} API valid endpoints are sent to server")
	public void get_nb_excel_contract_possible_to_export_api_valid_endpoints_are_sent_to_server(Integer int1) {
		RestAssured.baseURI= baseUrl+ "/v2/interfacecontract/";
		RestAssured.basePath="{environment}/export/nbExcelContractPossibleToExport";
	...
	@Then("Response of Nb Excel Contract API contains {int}")
	public void response_of_nb_excel_contract_api_contains(Integer int1) {
